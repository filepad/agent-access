# Windsurf Filepad Runtime Template

Use this for Windsurf rules plus Filepad MCP.
...
Add the Filepad MCP server through Windsurf's MCP settings using the standard
